...
public class QSchedule extends EntityPathBase<Schedule> {
    ...
    public final hansung.cse.withSpace.domain.space.QSpace space;
    ...
    public QSchedule(Class<? extends Schedule> type, PathMetadata metadata, PathInits inits) {
        ...
        this.space = inits.isInitialized("space") ? new hansung.cse.withSpace.domain.space.QSpace(forProperty("space"), inits.get("space")) : null;
    }
